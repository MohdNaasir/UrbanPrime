...
{!showSearch && (
  <IoSearchCircleOutline
    className='w-[30px] h-[30px] md:w-[30px] md:h-[30px] sm:w-[40px] sm:h-[40px] text-black cursor-pointer'
    onClick={() => { setShowSearch(prev => !prev); navigate("/collection") }}
  />
)}
{showSearch && (
  <IoSearchCircleSharp
    className='w-[50px] h-[50px] md:w-[70px] md:h-[70px] text-black cursor-pointer'
