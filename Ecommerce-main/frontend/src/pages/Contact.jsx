...
<div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
    ...
    <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]'>
        ...
        <p className='lg:w-[80%] w-[100%] text-white md:text-[16px] text-[13px]'>
            ...
            <p>Ghaziabad, Uttar Pardesh , India</p>
        </p>
        <p className='lg:w-[80%] w-[100%] text-white md:text-[16px] text-[13px]'>
            <p>Phone.No: +91-6396664639 </p>
            <p>Email: admin@UrbanPrime.com</p>
        </p>
        <p className='lg:w-[80%] w-[100%] lg:text-[18px] text-white font-bold mt-[10px] text-[13px]'>Careers at UrbanPrime </p>
...
<button className='px-[30px] py-[20px] flex items-center justify-center text-white bg-transparent border border-white rounded-md 
